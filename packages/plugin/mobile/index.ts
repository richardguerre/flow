...
import type { MobilePluginOptions } from "@flowdev/mobile-pwa/src/getPlugin/getPluginOptions";
...
export type { MobilePluginOptions as WebPluginOptions, PluginRoutineStepProps, OnCreateTask };
...
export type MobilePlugin = (options: MobilePluginOptions) => {
...
export const definePlugin = (plugin: MobilePlugin) => ({ plugin });

export type DefineMobilePluginReturn = ReturnType<typeof definePlugin>;
