    ...
    <IconContext.Provider value={{ size: "16px" }}>
      ...
      >
        ...
        <input
          ...
          ref={ref}
          className={tw(
            "ring-primary-200 -ring-offset-1 placeholder:text-foreground-700 text-foreground-900 disabled:bg-background-300/50 disabled:ring-none hover:ring-primary-300 focus:ring-primary-500 w-full rounded-md px-3 py-2 text-sm outline-none ring-2 transition-colors duration-300 ease-in-out",
