const y = (a, s) => ({ slug: a, plugin: s }),
  f = y("essentials", (a) => {
    const s = a.components,
      { motion: m } = a.framerMotion,
      t = a.React,
      u = 5,
      c = (e) => (
        t.useEffect(() => {
    ...
    return {
      ...
      routineSteps: {
        ...
        "retro-on-yesterday": {
          ...
          component: (e) => {
            const [o, r] = t.useState(null),
              l = a.dayjs().subtract(1, "day");
            return (
              t.useEffect(() => {
                (async () => {
              ...
              /* @__PURE__ */ t.createElement(
                "div",
                null,
                /* @__PURE__ */ t.createElement(s.NoteEditor, {
                  slug: `flow-essentials_retro-${l.format("YYYY-MM-DD")}`,
                  title: `Retro of ${l.format("MMMM D")}`,
                  loading: o === null,
                  initialValue: o ?? "",
                }),
                /* @__PURE__ */ t.createElement(e.BackButton, null),
                /* @__PURE__ */ t.createElement(e.NextButton, null)
              )
            );
          },
        },
          ...
          component: (e) => {
            ...
            return l
              ...
              : /* @__PURE__ */ t.createElement(
                  ...
                  /* @__PURE__ */ t.createElement(s.Day, { day: n, label: "Today" })
                );
          },
        },
            ...
            return d
              ...
              : /* @__PURE__ */ t.createElement(
                  ...
                  /* @__PURE__ */ t.createElement(
                    "div",
                    { className: "flex" },
                    /* @__PURE__ */ t.createElement(s.Day, {
                      day: n == null ? void 0 : n[0],
                      label: "Today",
                    }),
                    /* @__PURE__ */ t.createElement(s.Day, {
                      day: n == null ? void 0 : n[1],
                      label: "Tomorrow",
                    }),
                    /* @__PURE__ */ t.createElement(s.Day, {
                      day: n == null ? void 0 : n[2],
                      label: "Next week",
                    })
                  )
                );
        ...
        "intro-to-todays-shutdown": {
          ...
          component: (e) =>
            /* @__PURE__ */ t.createElement(c, { ...e }, "Let's reflect on what you did today"),
        },
        "clean-up-today": {
          name: "Clean up today",
          ...
          component: (e) => {
            ...
            return l
              ...
              : /* @__PURE__ */ t.createElement(
                  ...
                  /* @__PURE__ */ t.createElement(s.Day, { day: n, label: "Tomorrow" })
                );
          },
        },
      },
