const N = (s) => ({ plugin: s }), C = "gitstart-session-token", h = N((s) => {
  const r = s.components, t = s.React;
  return {
    name: "GitStart",
    settings: {
      [C]: {
    ...
    onCreateTask: async ({ task: n }) => {
      var a;
      return (a = n == null ? void 0 : n.item) != null && a.pluginDatas.some((e) => e.pluginSlug === "gitstart") ? {
        dialogContent: ({ NextButton: e, BackButton: l, ...c }) => {
          ...
          return /* @__PURE__ */ t.createElement("form", { onSubmit: u(p), className: "flex flex-col gap-4" }, /* @__PURE__ */ t.createElement(
            r.FormInput,
            {
              label: "Title",
          ...
          ), /* @__PURE__ */ t.createElement(e, { type: "submit" })));
        }
      } : null;
    },
    renderTaskCardDetails: async ({ task: n }) => {
      ...
      if (!a)
        return null;
      const e = a.min, l = f[e.type], c = x[e.status];
      return [
        {
          component: () => /* @__PURE__ */ t.createElement(r.Badge, { className: l.className }, l.label)
        },
        {
          component: () => /* @__PURE__ */ t.createElement(r.Badge, { className: c.className }, c.label)
        }
      ];
    },
    renderTaskCardActions: async ({ task: n }) => {
      ...
      return [
        {
          component: () => e.githubPrUrl ? /* @__PURE__ */ t.createElement("a", { href: e.githubPrUrl, target: "_blank", rel: "noreferrer" }, /* @__PURE__ */ t.createElement(r.CardActionButton, null, g)) : null
        },
        {
          component: () => /* @__PURE__ */ t.createElement("a", { href: e.ticketUrl, target: "_blank", rel: "noreferrer" }, i)
        }
      ];
    },
    renderItemCardDetails: async ({ item: n }) => {
      ...
      if (e.type === "pull_request") {
        ...
        return [
          {
            component: () => /* @__PURE__ */ t.createElement(r.Badge, { className: "bg-green-100 text-green-700" }, "PR")
          },
          {
            component: () => /* @__PURE__ */ t.createElement(r.Badge, { className: l.className }, l.label)
          }
        ...
        return [
          {
            component: () => /* @__PURE__ */ t.createElement(r.Badge, { className: "bg-gray-200 text-gray-600" }, "Ticket")
          },
          {
            component: () => /* @__PURE__ */ t.createElement(r.Badge, { className: l.className }, l.label)
          }
    ...
    renderItemCardActions: async ({ item: n }) => {
      ...
      return [
        {
          component: () => e.type === "pull_request" && e.url ? /* @__PURE__ */ t.createElement("a", { href: e.url, target: "_blank", rel: "noreferrer" }, /* @__PURE__ */ t.createElement(r.CardActionButton, null, g)) : null
        },
        {
          component: () => /* @__PURE__ */ t.createElement("a", { href: e.ticketUrl, target: "_blank", rel: "noreferrer" }, i)
        }
  ...
  FINISHED: { label: "Finished", className: "bg-green-100 text-green-700" },
  CANCELED: { label: "Canceled", className: "bg-red-100 text-red-600" }
}, i = /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 82 81", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ React.createElement("ellipse", { cx: "41", cy: "40.5", rx: "41", ry: "40.5", fill: "#FCEED4" }), /* @__PURE__ */ React.createElement(
  "path",
  {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
